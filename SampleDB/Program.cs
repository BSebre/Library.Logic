...
namespace SampleDB
{
	class Program
	{
		static void Main(string[] args)
		{
			...
			// I - SqlDataClient
			string dbConnection = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Baibeens\Desktop\Bootcamp\Library.Logic\MyFirstDB\FirstDB.mdf;Integrated Security=True;Connect Timeout=30";
            ...
            using (SampleDatabase db = new SampleDatabase())
            {
                List<User> users = db.Users.OrderBy(u => u.RegisteredOn).ToList();
